                    ...
                    <fieldset>
                        ...
                        if ($built_in_post_types) {
                            ...
                            foreach ($built_in_post_types as $post_type) {
                                ?>
                                <label for="post_type_option_<?php echo esc_attr($post_type); ?>">
                                    <input name="post_type_option[]" type="checkbox"
                                           id="post_type_option_<?php echo esc_attr($post_type); ?>"
                    ...
                    <fieldset>
                        ...
                        if ($built_in_taxonomies) {
                            ...
                            foreach ($built_in_taxonomies as $taxonomy) {
                                ?>
                                <label for="taxonomy_option_<?php echo esc_attr($taxonomy); ?>">
                                    <input name="taxonomy_option[]" type="checkbox"
                                           id="taxonomy_option_<?php echo esc_attr($taxonomy); ?>"
    ...
    <table class="audit-list striped">
        ...
        foreach ($audits as $audit) {
            ...
            <tr>
                ...
                <td>
                    <a href="<?php echo esc_url($file); ?>"><?php _e('Download', 'content-audit-exporter'); ?></a>
                    |
                    <!-- FORM -->
